...
classifiers
  = HashMap.fromList
      [("\25490\28783\33410",
       ...
       ("month (grain)",
        Classifier{okData =
                     ClassData{prior = -0.9227216222044455,
                               unseen = -3.4965075614664802,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 31},
                   koData =
                     ClassData{prior = -0.5065612249795332, unseen = -3.891820298110627,
                                 ...
                                 HashMap.fromList
                                   [("\20799\31461\33410<part-of-day> <dim time>",
                                    ...
                                    ("year (numeric with year symbol)\20809\26126\33410",
                                     -4.2626798770413155),
                                    ("xxxx year<named-month> <day-of-month>", -4.955827057601261),
                                    ("daymonth", -4.2626798770413155),
                                    ("monthday", -1.9354021714568983),
                                    ("next yearSeptember", -5.243509130053042),
                                    ("year (numeric with year symbol)\25995\26376",
                                     -4.955827057601261),
                                    ("year (numeric with year symbol)\20061\22812\33410",
                                     -4.955827057601261),
                                    ("year (numeric with year symbol)February", -4.732683506287051),
                                    ("xxxx yearintersect", -4.955827057601261),
                                    ("March<time> <day-of-month>", -3.7771720612596145),
                                    ("year (numeric with year symbol)<named-month> <day-of-month>",
                                     -3.5089080746649355),
                                    ("monthhour", -3.7771720612596145),
                                    ("year (numeric with year symbol)\22320\29699\19968\23567\26102",
                                     -5.243509130053042),
                                    ("year (numeric with year symbol)April", -5.243509130053042),
                                    ("dayday", -2.299070150886601),
                                    ("hourhour", -4.396211269665838),
                                    ("xxxx yearFebruary", -5.648974238161206),
                                    ("year (numeric with year symbol)March", -4.144896841384932),
                                    ("February<dim time> <part-of-day>", -3.7771720612596145),
                                    ("hourminute", -4.732683506287051),
                                    ("April<time> <day-of-month>", -5.243509130053042),
                                    ("February<time> <day-of-month>", -2.6285493520168437),
                                    ("absorption of , after named day<named-month> <day-of-month>",
                                     -3.634071217618941),
                                    ("year (numeric with year symbol)\22823\25995\26399",
                                     -4.955827057601261),
                                    ("this <cycle><time> <day-of-month>", -4.550361949493096),
                                    ("year (numeric with year symbol)\22235\26092\33410",
                                     -5.243509130053042),
                                    ("yearmonth", -3.3463891451671604),
                                    ("year (numeric with year symbol)\20303\26842\33410",
                                     -5.243509130053042),
                                    ("dayminute", -4.732683506287051),
                                    ("next <cycle>September", -5.648974238161206),
                                    ("intersect by \",\"<time> <day-of-month>", -3.634071217618941),
                                    ("xxxx yearMarch", -5.648974238161206),
                                    ("absorption of , after named dayintersect",
                                     -3.634071217618941),
                                    ("intersect<time> <day-of-month>", -2.81576089410499),
                                    ("next <cycle><time> <day-of-month>", -4.955827057601261),
                                    ("tonight<time-of-day> o'clock", -4.396211269665838),
                                    ("year (numeric with year symbol)intersect",
                                     -3.5089080746649355),
                                    ("yearday", -2.0936261766717923),
                                    ...
                                    ("year (numeric with year symbol)\29369\22826\26032\24180",
                                     -5.243509130053042),
                                    ("yearminute", -5.243509130053042),
                                    ("<dim time> <part-of-day>relative (10-59) minutes after|past <integer> (hour-of-day)",
                                     -4.732683506287051)],
                               n = 260},
                   koData =
                     ClassData{prior = -2.908720896564361, unseen = -4.3694478524670215,
                               likelihoods =
                                 HashMap.fromList
                                   [("\20799\31461\33410<part-of-day> <dim time>",
                                     -2.159484249353372),
       ...
       ("week (grain)",
        Classifier{okData =
                     ClassData{prior = -0.8732733467904642,
                               unseen = -3.6888794541139363,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 38},
                   koData =
                     ClassData{prior = -0.5405675929647281, unseen = -4.007333185232471,
       ...
       ("this <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.8266785731844679, unseen = -3.891820298110627,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.3062516534463542),
                                    ("month (grain)", -2.0794415416798357),
                                    ("year (grain)", -2.2617630984737906),
                                    ("week (grain)", -1.3062516534463542),
                                    ("year", -2.2617630984737906), ("month", -2.0794415416798357)],
                               n = 21},
                   koData =
                     ClassData{prior = -0.5753641449035618, unseen = -4.110873864173311,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -0.7621400520468967),
                                    ("week (grain)", -0.7621400520468967)],
                               n = 27}}),
       ("minute (grain)",
        Classifier{okData =
       ...
       ("integer (0..10)",
        Classifier{okData =
                     ClassData{prior = -0.5971671335875551, unseen = -5.420534999272286,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 224},
                   koData =
                     ClassData{prior = -0.7993270326011741, unseen = -5.220355825078324,
